...
class FreshExtension_aiconverter_Controller extends Minz_ActionController {
    ...
    public function processAction() {
        ...
        try {
            ...
            $pendingEntries = $entryDAO->listWhere('e', 0, FreshRSS_Entry::STATE_ALL, null, '0', '0', 'id', 'DESC', '0', [], $batchSize * 3);
    ...
    public function countPendingAction() {
        ...
        try {
            ...
            $entryDAO = FreshRSS_Factory::createEntryDAO();
            $entries = $entryDAO->listWhere('e', 0, FreshRSS_Entry::STATE_ALL, null, '0', '0', 'id', 'DESC', '0', [], 1000);
